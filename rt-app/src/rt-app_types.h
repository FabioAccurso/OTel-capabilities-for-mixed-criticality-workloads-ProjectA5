...
/****************** OTEL - Defaults for instrumentation ******************/
#ifndef RTAPP_TRACE_LEVEL
#define RTAPP_TRACE_LEVEL 0		// No instrumentation
#endif

#ifndef RTAPP_PROCESSOR_TYPE
#define RTAPP_PROCESSOR_TYPE 0	// Batch Processor
#endif

#ifndef RTAPP_SAMPLER_TYPE
#define RTAPP_SAMPLER_TYPE 0	// AlwaysOn Sampler
#endif
...
#ifndef RTAPP_EXPORTER_TYPE
#define RTAPP_EXPORTER_TYPE 0	// Zipkin Exporter (1 = OStream on stdout, 2 = OStream on a file in logdir)
#endif
/************************************************************************/

/************************** CGROUP - Defaults ***************************/
#ifndef RTAPP_CGROUP_ENABLED
#define RTAPP_CGROUP_ENABLED 0
#endif
/************************************************************************/
